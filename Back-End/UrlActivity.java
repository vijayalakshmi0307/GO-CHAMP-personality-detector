...
import com.my.newproject.AboActivity;
    ...
    private void initialize(Bundle bundle) {
        ...
        this.textview2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                UrlActivity.this.t.setAction("android.intent.action.VIEW");
                UrlActivity.this.t.setData(Uri.parse((String)"https://www.careerguide.com/career-experts/chennai"));
                UrlActivity.this.startActivity(UrlActivity.this.t);
            }
        });
        this.button1.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                UrlActivity.this.t.setClass(UrlActivity.this.getApplicationContext(), AboActivity.class);
                UrlActivity.this.startActivity(UrlActivity.this.t);
            }
        });
    }
